...
class MyTheme {
  ...
  static ThemeData lightTheme = ThemeData(
      ...
      appBarTheme: AppBarTheme(
          backgroundColor: primaryLightColor, centerTitle: true,
      ...
      textTheme: TextTheme (
        ...
        titleMedium: TextStyle( fontSize: 20 , fontWeight: FontWeight.w300, color: blackColor),
        titleSmall: TextStyle( fontSize: 18 , fontWeight: FontWeight.normal, color: blackColor),
      )
  );
}
